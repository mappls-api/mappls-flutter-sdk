...
import 'package:mappls_flutter_demo/widget/camera/location_camera_option_widget.dart';
...
import 'package:mappls_flutter_demo/widget/marker/add_custom_marker_widget.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: <String, WidgetBuilder> {
        ...
        '/add_custom_marker': (BuildContext context) => AddCustomMarkerWidget()
      },
    );
  }
}